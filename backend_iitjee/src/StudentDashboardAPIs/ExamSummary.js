  ...
  async (req, res) => {
    ...
    try {
      ...
      const marks = userResponseRows.map((row) => {
        ...
        //       status = 1;
        //     } else {
        //       marksAwarded = parseFloat(row.nmarks_text) || 0; // No negative for NVQs
        //       status = 0;
        //     }
        //   }
        // } else if (examId === 2) {
        ...
        //     // MCQ - Multiple correct (Matching type logic)
        ...
        //     const isAllCorrect =
        //       correctOptions.length === userOptions.length &&
        //       correctOptions.every((v, i) => v === userOptions[i]);
        ...
        //       const matched = userOptions.filter((o) =>
        //         correctSet.has(o)
        //       ).length;
        ...
        //       if (
        //         matched === correctOptions.length - 1 &&
        //         userOptions.length === matched
        //       ) {
        //         marksAwarded = 3;
        //       } else if (matched === 2 && userOptions.length === 2) {
        //         marksAwarded = 2;
        //       } else if (matched === 1 && userOptions.length === 1) {
        //         marksAwarded = 1;
        //       } else {
        //         marksAwarded = -2;
        //       }
