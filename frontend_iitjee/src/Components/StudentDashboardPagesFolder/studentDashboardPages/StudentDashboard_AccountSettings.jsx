    ...
    <div className={styles.studetnDashboard_SettingsHomePage}>
      ...
      <FaCircleUser />
        ...
        <div className={styles.StudentAccountPwds}>
          <div  className={`${styles.passwordsButton} ${activeSection === 'profile' ? styles.active : ''}`}
            onClick={() => setActiveSection('profile')}>Profile Update</div>
          <div  className={`${styles.passwordsButton} ${activeSection === 'password' ? styles.active : ''}`}
            onClick={() => setActiveSection('password')}>Change Password</div>
        </div>
        ...
        <form className={styles.StudentResetPassword}>
          ...
          <input  type={showPassword.new ? 'text' : 'password'} 
                className={styles.passwordInput} required/>
                <span onClick={() => togglePasswordVisibility('new')} className={styles.eyeIcon}>
        ...
        <ul className={styles.listofMandatory}>
          ...
          <input  type={showPassword.confirm ? 'text' : 'password'} 
                className={styles.passwordInput} required/>
                 <span onClick={() => togglePasswordVisibility('confirm')} className={styles.eyeIcon}>
