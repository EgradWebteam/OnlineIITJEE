        ...
        <div className={styles.StudentReportMainDiv}>
            <div className={styles.StudentReportSubDiv}>
                <div className={styles.studentReportHeaderMain}>
                    ...
                    <button className={styles.studentReportBackButton}>
                ...
                <div className={styles.studentReportTestDetailsContiner}>
                    <ul className={styles.testDetailsContainerSub}>
                        <li>Test Name: <b>..</b></li>
                        <li>TotalMatks: <b>..</b></li>
                        <li>Duration: <b>..</b></li>
                    </ul>
                </div>
                <div className={styles.studentReportPerformanceBtns}>
                    <button 
                     className={`${styles.performanceButtonsInStudentReport} ${activeTab === 'Your Performance' ? styles.performanceBtnActive : ''}`}
                     onClick={() => setActiveTab('Your Performance')}
                     >
                        Your Performance
                    </button>
                    <button  
                     className={`${styles.performanceButtonsInStudentReport} ${activeTab === 'Solutions' ? styles.performanceBtnActive : ''}`}
